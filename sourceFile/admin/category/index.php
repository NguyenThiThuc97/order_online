...
//lấy danh dách toàn bộ các nhân viên
  ...
  //add new a category
  $newName=trim($b->getPOST("cate_name"));
  


  if($b->getPOST("submit") && $newName)
  {
    $result=$listCate->addNewCate($newName);
    if($result===true){
      //back to index.php with action="view"
    
      header("Location:".$b->createURL("category/index", ["action"=>"view"]));
    }
    else{
      var_dump("false");die();
    }
  ...
  {
    $updateUser=$listCate->buildQueryParams(
      [
        "where"=>"update_category(:ids, :names)",
        "params"=>
        [
          ":ids"=>$idUpdate,
    ...
    if($updateUser)
    {
      ...
      $link_ne=$b->createURL("category/index", ["action"=>"view"]);
          ...
          <div class="">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>List of all categories<small>Custom design</small></h2>
                        ...
                        <tbody>
                          <?php foreach ($Cate as $value) {  
                           ...
                           <tr>
                              ...
                              <td><a href="<?= $b->createURL("category/index", ["action"=>"update", "idUpdate"=>$value["categoryID"]])?>"><i class="fa fa-wrench"></i></a></td>
                              <td><a href="<?= $b->createURL("category/delete", ["idCate"=>$value["categoryID"]])?>"><i class="fa fa-close"></i></a></td>
                           </tr>
                           <?php } ?>
                        </tbody>
                      </table>
            ...
            ?>
              <div class="x_content">
                    <br />
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo $b->createURL('category/index'); ?>" method="post">

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">New name of category product <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12" name="cate_name">
                        </div>
                      </div>
                ...
                <?php } else if($b->getGET("action")==="update") { 
                  ...
                  $otherCate=$listCate->view_category_with_id($idNeUpdate);
                  ...
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo $b->createURL('category/index', ["idUpdate"=>$idNeUpdate]); ?>" method="post">
                      <!-- no see password -->
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Category Name <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12" name="name_for_update" value="<?php echo $otherCate["categoryName"] ?>">
                        </div>
                      </div>
                      <!-- <div class="form-group">
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <a href="<?= $b->createURL("category/index", ["action"=>"view"])?>"><button class="btn btn-primary" type="button">Cancel</button></a>
